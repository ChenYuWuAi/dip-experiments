...
CBitPlaneDlg::CBitPlaneDlg(const std::vector<CDib>& bitPlanes, CWnd* pParent /*=nullptr*/)
    : CDialogEx(IDD_BITPLANE_DLG, pParent), m_bitPlanes(bitPlanes), m_currentPlane(0) {
}
